...
<div id="release_offer" class="container-fluid nav_shadow">
	<div id="release_head_offer" class="container-fluid">
		<div class="container">
			<div class="row py-4 justify-content-around">
				<div class="release_logo px-3">
					<span class="release_title pr-3">悬赏帖</span> <span
						class="release_sub">我们凭本事吃饭</span>
				</div>
	...
	<div id="release_offer_content" class="container nav_shadow">
		...
		<div class="row pb-5">
			<!--release_left-->
			<div id="release_left" class="col-sm-12 ">
					...
					<div class="row">
						<c:forEach var="skill" items="${skillList}">
							<div class="col-lg-3 col-md-4 col-sm-12 my-2">
								<div class="release_item background_depart">
									<div class="row my-3 justify-content-around">
										<h3 class="skill_category_head mt-3">${skill.rsTitle}</h3>
										<div class="skill_category_pic">
											<img src="<%=request.getContextPath()%>/${skill.rsPublisher.picture}" height="50" width="50" />
										</div>
									</div>
									...
									<div class="row mb-3 px-1 justify-content-around">
										<span class="skill_thumb"> <i class="fa fa-won"></i> <span>100</span>
										</span> <a class="skill_category_link" href="reward_details?id=${skill.rsId}">查看详情</a>
									</div>
								</div>
							</div>
						</c:forEach>
